	...
	public void genericInerTypes() {
		...
		CompilationSubject.assertThat(compilation)
			...
			.hasSourceEquivalentTo(JavaFileObjects.forSourceLines("MTestDto",
					...
					"	}",
					"",
					"	private static class MTestDto_TestGenericDtoLong extends MetaBean<TestGenericDto> {",
					"",
					"		public static final MTestDto_TestGenericDtoLong meta = new MTestDto_TestGenericDtoLong();",
					"",
					...
					"",
					"		public MTestDto_TestGenericDtoLong() {",
					"			super(TestGenericDto.class);",
					"		}",
					"",
					"		public MTestDto_TestGenericDtoLong(MetaBean<?> parent) {",
					"			super(parent, TestGenericDto.class);",
					"		}",
					"",
					"		public MTestDto_TestGenericDtoLong(MetaBean<?> parent, String alias) {",
					"			super(parent, TestGenericDto.class, alias);",
					"		}",
					"",
					"	}",
					"",
					"	private static class MTestDto_TestGenericDtoDate extends MetaBean<TestGenericDto> {",
					"",
					"		public static final MTestDto_TestGenericDtoDate meta = new MTestDto_TestGenericDtoDate();",
					"",
					"		public final MetaField<Date> value = createField(Date.class, \"value\");",
					"		public final MetaField<Date> date = createField(Date.class, \"date\");",
					"",
					"		public MTestDto_TestGenericDtoDate() {",
					"			super(TestGenericDto.class);",
					"		}",
					"",
					"		public MTestDto_TestGenericDtoDate(MetaBean<?> parent) {",
					"			super(parent, TestGenericDto.class);",
					"		}",
					"",
					"		public MTestDto_TestGenericDtoDate(MetaBean<?> parent, String alias) {",
					"			super(parent, TestGenericDto.class, alias);",
					"		}",
					"",
					"	}",
